...
"""
    ...
    def _call_llm_for_csv(self, prompt: Dict[str, str]) -> Dict[str, Any]:
        ...
        # Some OpenRouter Gemma providers reject system/developer instructions.
        # For those routes, merge the system instructions into a single user turn
        # so the same prompt content can still be executed.
        if is_openrouter and 'gemma' in model_name.lower():
            messages = [{
                "role": "user",
